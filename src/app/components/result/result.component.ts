    ...
    <div class="page-container">
      <div class="result-card">
        ...
        <p class="completion-message">
          You have successfully completed all verification challenges.
        </p>
        ...
        <div class="results-list">
          ...
          <div class="result-item" *ngFor="let result of challengeResults; let i = index">
            ...
            <div
              class="result-status"
              [class.success]="result.isCorrect"
              [class.failure]="!result.isCorrect"
            >
              {{ result.isCorrect ? '' : '' }}
            </div>
          </div>
        ...
        <div class="actions">
          ...
          <button class="btn-primary" (click)="startNewChallenge()">Start New Challenge</button>
        </div>
      </div>
    </div>
  `,
